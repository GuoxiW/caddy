...
import (
	...
	"github.com/GuoxiW/caddy/caddyfile"
	"github.com/GuoxiW/caddy/caddytls"
	"github.com/GuoxiW/caddy/telemetry"
	"github.com/mholt/certmagic"
	lumberjack "gopkg.in/natefinch/lumberjack.v2"

	_ "github.com/GuoxiW/caddy/caddyhttp" // plug in the HTTP server type
...
func getBuildModule() *debug.Module {
	...
	if ok {
		...
		for _, mod := range bi.Deps {
			if mod.Path == "github.com/GuoxiW/caddy" {
				return mod
			}
		}
	}
